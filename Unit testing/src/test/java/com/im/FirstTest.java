...
public class FirstTest {
    ...
    void shouldReturnNewString_When_SubstringIsFound() {
        //given
        String mainString = "Kshitija Verma is a Trainee";
        String findstring = "Trainee";
        String replacedString = "Employee";
        String expectedString = "Kshitija Verma is a Employee";
    ...
    void shouldReturnOriginalString_When_SubstringIsNotFound() {
        //given
        String mainString = "Kshitija Verma";
        String findstring = "Rajput";
        String replacedString = "Singh";
        String expectedString = "Kshitija Singh";
